...
2. Pipe the diff into Claude with the `team-review` skill.
   ```bash
   // turbo
   git diff <range> | claude --verbose "Apply the team-review skill from .agents/skills/team-review/SKILL.md. Output Critical/High/Medium/Low."
   ```
