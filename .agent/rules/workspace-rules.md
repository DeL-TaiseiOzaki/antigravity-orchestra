# Workspace Rules (Antigravity)

These rules are always-on guidance for any Antigravity agent working in this
repository. They do not replace `AGENTS.md`; they describe how an
...
- See `.agents/skills/codex-system/SKILL.md` and
  `.agents/skills/claude-system/SKILL.md` for invocation patterns.

## Session hygiene
- Past ~20 turns or when responses get terse, run the `checkpointing`
  skill before the user has to ask.
